  ...
  return (
    <div className="w-full h-auto px-[15px] bg-[#1c1a32] flex justify-between items-center">
      ...
      <div className="flex items-center justify-center">
        ...
        />
        <p className="text-[30px] font-bold text-white">QuickCart</p>
      </div>

      {/* Navigation Links */}
      <ul className="flex items-center justify-center gap-[30px] Laptop:hidden">
        <Link to={"/"}>
      ...
      <div className="flex items-center justify-center gap-[20px] Laptop:hidden">
        <Link to={"/login"}>
